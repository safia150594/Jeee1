...
@Component({
  selector: 'app-rent-short-terms-monthly',
  templateUrl: './rent-short-terms-monthly.component.html',
  styleUrls: ['./rent-short-terms-monthly.component.scss']
})
export class RentShortTermsMonthlyComponent implements OnInit {
